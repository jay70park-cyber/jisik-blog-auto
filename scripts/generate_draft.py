...
def build_score_table_html(rows):
    ...
    trend_decimals = 2
    score_decimals = 2
    th_style = "border:1px solid #ddd;padding:9px 12px;background:#EEF2FB;color:#1F3C88;font-weight:700;font-size:17px;"
    th_style_right = th_style + "text-align:right;"
    td_style = "border:1px solid #ddd;padding:9px 12px;font-size:17px;"
    ...
    return (
        '<table align="center" style="border-collapse:collapse;width:100%;"><thead><tr>'
...
def render_naver_html(markdown_text, title="블로그 초안", category_display=None, top_keyword=None, rows=None):
    ...
    def _wrap_insight(match):
        inner = match.group(1)
        box_style = "background:#EEF2FB;border-radius:12px;padding:18px 20px;color:#222;line-height:1.8;font-size:20px;"
        label_style = "display:block;font-size:16px;font-weight:800;color:#C9932F;letter-spacing:1px;margin-bottom:8px;"
        return (
            '<div style="' + box_style + '">'
