...
def build_score_table_html(rows):
    ...
    trend_decimals = 2
    score_decimals = 2
    th_style = "border:1px solid #ddd;padding:9px 8px;background:#EEF2FB;color:#1F3C88;font-weight:700;font-size:15px;white-space:nowrap;"
    ...
    colgroup = ('<colgroup><col style="width:32%"><col style="width:17%"><col style="width:17%">'
    ...
    return (
        ...
        + colgroup +
        '<thead><tr>'
        '<th width="30%" style="' + th_style + 'width:30%;">키워드</th>'
        '<th width="17.5%" style="' + th_style_right + 'width:17.5%;">블로그 건수</th>'
        '<th width="17.5%" style="' + th_style_right + 'width:17.5%;">카페 건수</th>'
        '<th width="17.5%" style="' + th_style_right + 'width:17.5%;">검색트렌드지수</th>'
        '<th width="17.5%" style="' + th_style_right + 'width:17.5%;">관심도스코어</th>'
