...
_H1_STYLE = "font-size:24px;margin-top:32px;margin-bottom:14px;color:#1F3C88;font-weight:800;"
_H2_STYLE = "font-size:20px;margin-top:30px;margin-bottom:12px;color:#1F3C88;font-weight:800;border-bottom:3px solid #C9932F;padding-bottom:6px;"
_H3_STYLE = "font-size:18px;margin-top:22px;margin-bottom:10px;color:#1F3C88;font-weight:700;"
...
_BLOCKQUOTE_STYLE = "margin:6px 0 18px 0;padding:8px 14px;background:#f7f8fa;border-left:3px solid #C9932F;color:#555;font-size:14px;"
...
def _inline_styles(html):
    ...
    html = re.sub(r"<blockquote>", '<blockquote style="' + _BLOCKQUOTE_STYLE + '">', html)
